...
function renderWorldMap(distribution){
  ...
  return `<svg viewBox="0 0 1000 500" role="img" aria-label="${distribution?.label||"物种分布范围示意图"}"><g class="graticule">${graticules}</g><g class="land"><path d="M45 105L95 58L175 45L238 82L260 132L222 168L205 215L155 208L122 175L72 168Z"/><path d="M228 224L278 244L304 305L286 382L251 452L218 407L198 324Z"/><path d="M430 105L480 70L570 65L630 88L710 74L820 112L895 158L866 204L774 191L706 220L628 184L570 174L532 198L468 174Z"/><path d="M477 194L548 190L592 238L575 330L528 397L486 350L455 270Z"/><path d="M779 320L850 299L910 326L925 378L872 404L805 386Z"/><path d="M368 89L402 69L421 102L395 129Z"/><path d="M904 206L933 215L945 260L921 279L899 245Z"/></g><g class="ranges">${polygons}</g></svg>`;
}
